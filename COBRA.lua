...
if text == (database:get(bot_id.."COBRA:Name:Bot") or "كوبرا") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."COBRA:Name:Bot") or "كوبرا")
local namebot = {
...
local Name_Bot = (database:get(bot_id.."COBRA:Name:Bot") or "كوبرا")
